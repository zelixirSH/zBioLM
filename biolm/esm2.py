...
class EsmSelfAttention(nn.Module):
    def __init__(self, config, position_embedding_type=None):
        ...
        elif self.position_embedding_type == "scaled_rotary":
            self.rotary_embeddings = ScaledRotaryEmbedding(dim=self.attention_head_size)
    ...
    def forward(
        ...
        if self.position_embedding_type == "rotary" or self.position_embedding_type == "scaled_rotary":
