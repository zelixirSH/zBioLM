...
def get_data_loader(data_dir, ddp, batch_size, num_workers, tok_mode='char', **kwargs):
    ...
    # df = pd.read_csv(f'{data_dir}/UTR/from_sx/Heart_train.csv')
    df = pd.read_csv(f'{data_dir}/UTR/from_sx/MUSCLE_train.csv')
    train_dataset = PADataset(df, mode='train', fold=fold, crop_size=crop_size, tok_mode=tok_mode)
    ...
    # df = pd.read_csv(f'{data_dir}/UTR/from_sx/Heart_test.csv')
    df = pd.read_csv(f'{data_dir}/UTR/from_sx/MUSCLE_test.csv')
...
if __name__ == '__main__':
    ...
    train_sampler, train_loader, valid_loader,_ = get_data_loader(ddp, batch_size, num_workers, tok_mode='MarsTok')
