...
from biolm.modules.moe.moe_calculators import (
    CalculatorOutput,
    SwitchDropTokenCalculator,
    UniformCalculator,
    UniversalCalculator,
)
from biolm.modules.moe.moe_experts import LinearExperts, LinearGLUExperts
from biolm.modules.moe.moe_gates import (
    RandomLearnableGate,
    RandomPlainGate,
    SwitchBalancedGate,
...
def unitest_moe_layers():
    '''

    '''

    layer = LinearMoELayer(10, 10, 10, 10)
    print(layer)
    ...
    # unitest LinearGLUMoELayer
    layer = LinearGLUMoELayer(10, 10, 10, 'relu', 10, 10)
    print(layer)
